...
#import "biryaniViewController.h"
#import "DetailsViewController.h"
@interface biryaniViewController ()

@end

@implementation biryaniViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle]pathForResource:@"Biryani" ofType:@"plist"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row %2 ==1){
		...
		cell.backgroundColor = [UIColor colorWithRed:.8 green:.6 blue:.4 alpha:1];}
...
{
            if ([segue.identifier isEqualToString:@"biryani"]) {
